...
image:
   title: "IMG_0164-thumb.jpg"


gallery:
   -image_url: "IMG_0164-thumb.jpg"
...
<div>
	<ul class="clearing-thumbs small-block-grid-4" data-clearing>
    	...
    	<ul>	{% for item in page.gallery %}
        <li><img src="{{ site.urlimg }}{{ item.image_url }}" /> </li>
</ul>
</div>


<img src="{{ site.urlimg }}{{ post.image.title }}" />
<img src="{{ site.urlimg }}{{ post.gallery.image_url }}" />
